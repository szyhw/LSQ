...
public class MoreOpt {
	...
	public static void find_moreopt(){
		...
		File file =new File("G:\\QueryText_AndOpt_NormalForm_MoreOpt.txt");
		...
		try {
			...
			FileWriter fileWritter = new FileWriter("G:\\QueryText_AndOpt_NormalForm_MoreOpt.txt",true);
